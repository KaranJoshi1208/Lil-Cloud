...
public val MyIconPack.`Cloudy-2-night`: ImageVector
    get() {
        if (`_cloudy-2-night` != null) {
            return `_cloudy-2-night`!!
        }
        `_cloudy-2-night` = Builder(name = "Cloudy-2-night", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_cloudy-2-night`: ImageVector? = null
