...
public val MyIconPack.`Isolated-thunderstorms`: ImageVector
    get() {
        if (`_isolated-thunderstorms` != null) {
            return `_isolated-thunderstorms`!!
        }
        `_isolated-thunderstorms` = Builder(name = "Isolated-thunderstorms", defaultWidth = 56.0.dp,
...
private var `_isolated-thunderstorms`: ImageVector? = null
