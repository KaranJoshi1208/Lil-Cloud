...
public val MyIconPack.`Isolated-thunderstorms-day`: ImageVector
    get() {
        if (`_isolated-thunderstorms-day` != null) {
            return `_isolated-thunderstorms-day`!!
        }
        `_isolated-thunderstorms-day` = Builder(name = "Isolated-thunderstorms-day", defaultWidth =
...
private var `_isolated-thunderstorms-day`: ImageVector? = null
