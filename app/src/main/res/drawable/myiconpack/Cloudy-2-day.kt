...
public val MyIconPack.`Cloudy-2-day`: ImageVector
    get() {
        if (`_cloudy-2-day` != null) {
            return `_cloudy-2-day`!!
        }
        `_cloudy-2-day` = Builder(name = "Cloudy-2-day", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_cloudy-2-day`: ImageVector? = null
