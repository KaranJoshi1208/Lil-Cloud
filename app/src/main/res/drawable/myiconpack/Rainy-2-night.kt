...
public val MyIconPack.`Rainy-2-night`: ImageVector
    get() {
        if (`_rainy-2-night` != null) {
            return `_rainy-2-night`!!
        }
        `_rainy-2-night` = Builder(name = "Rainy-2-night", defaultWidth = 56.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF91c0f8)),
                ...
                moveTo(23.9175f, 33.9429f)
                lineTo(22.5283f, 41.8214f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF91c0f8)),
                    strokeLineWidth = 2.0f, strokeLineCap = StrokeCap.Companion.Round,
                    strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(30.1736f, 33.0152f)
                lineTo(28.7845f, 40.8937f)
            }
        }
        .build()
        return `_rainy-2-night`!!
...
private var `_rainy-2-night`: ImageVector? = null
