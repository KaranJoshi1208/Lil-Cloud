...
public val MyIconPack.`Cloudy-3-night`: ImageVector
    get() {
        if (`_cloudy-3-night` != null) {
            return `_cloudy-3-night`!!
        }
        `_cloudy-3-night` = Builder(name = "Cloudy-3-night", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_cloudy-3-night`: ImageVector? = null
