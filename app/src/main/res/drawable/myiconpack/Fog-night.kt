...
public val MyIconPack.`Fog-night`: ImageVector
    get() {
        if (`_fog-night` != null) {
            return `_fog-night`!!
        }
        `_fog-night` = Builder(name = "Fog-night", defaultWidth = 56.0.dp, defaultHeight = 48.0.dp,
...
private var `_fog-night`: ImageVector? = null
