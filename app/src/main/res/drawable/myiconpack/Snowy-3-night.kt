...
public val MyIconPack.`Snowy-3-night`: ImageVector
    get() {
        if (`_snowy-3-night` != null) {
            return `_snowy-3-night`!!
        }
        `_snowy-3-night` = Builder(name = "Snowy-3-night", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_snowy-3-night`: ImageVector? = null
