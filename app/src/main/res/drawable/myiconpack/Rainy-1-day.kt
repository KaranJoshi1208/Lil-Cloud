...
public val MyIconPack.`Rainy-1-day`: ImageVector
    get() {
        if (`_rainy-1-day` != null) {
            return `_rainy-1-day`!!
        }
        `_rainy-1-day` = Builder(name = "Rainy-1-day", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_rainy-1-day`: ImageVector? = null
