...
public val MyIconPack.`Cloudy-3-day`: ImageVector
    get() {
        if (`_cloudy-3-day` != null) {
            return `_cloudy-3-day`!!
        }
        `_cloudy-3-day` = Builder(name = "Cloudy-3-day", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_cloudy-3-day`: ImageVector? = null
