...
public val MyIconPack.`Snowy-1-night`: ImageVector
    get() {
        if (`_snowy-1-night` != null) {
            return `_snowy-1-night`!!
        }
        `_snowy-1-night` = Builder(name = "Snowy-1-night", defaultWidth = 56.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    ...
                    strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(29.7678f, 33.2323f)
                lineTo(26.2322f, 36.7678f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = StrokeCap.Companion.Round,
                    strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = StrokeCap.Companion.Round,
                    strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(29.7677f, 36.7678f)
                lineTo(26.2322f, 33.2323f)
            }
        }
        .build()
        return `_snowy-1-night`!!
...
private var `_snowy-1-night`: ImageVector? = null
