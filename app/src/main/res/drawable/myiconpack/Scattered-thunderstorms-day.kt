...
public val MyIconPack.`Scattered-thunderstorms-day`: ImageVector
    get() {
        if (`_scattered-thunderstorms-day` != null) {
            return `_scattered-thunderstorms-day`!!
        }
        `_scattered-thunderstorms-day` = Builder(name = "Scattered-thunderstorms-day", defaultWidth
...
private var `_scattered-thunderstorms-day`: ImageVector? = null
