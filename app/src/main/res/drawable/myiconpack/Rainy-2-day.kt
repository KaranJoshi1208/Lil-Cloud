...
public val MyIconPack.`Rainy-2-day`: ImageVector
    get() {
        if (`_rainy-2-day` != null) {
            return `_rainy-2-day`!!
        }
        `_rainy-2-day` = Builder(name = "Rainy-2-day", defaultWidth = 56.0.dp, defaultHeight =
                48.0.dp, viewportWidth = 56.0f, viewportHeight = 48.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = SolidColor(Color(0xFFffa500)),
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF91c0f8)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(23.9174f, 33.9427f)
                lineTo(22.5282f, 41.8212f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF91c0f8)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(30.1735f, 33.015f)
                lineTo(28.7843f, 40.8934f)
            }
        }
        .build()
        return `_rainy-2-day`!!
...
private var `_rainy-2-day`: ImageVector? = null
