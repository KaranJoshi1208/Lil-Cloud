...
public val MyIconPack.`Snowy-2-day`: ImageVector
    get() {
        if (`_snowy-2-day` != null) {
            return `_snowy-2-day`!!
        }
        `_snowy-2-day` = Builder(name = "Snowy-2-day", defaultWidth = 56.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF57a0ee)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.2f, strokeLineCap = Butt, strokeLineJoin =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    ...
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(24.7678f, 33.2323f)
                lineTo(21.2322f, 36.7678f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(24.7677f, 36.7678f)
                lineTo(21.2322f, 33.2323f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.2f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(33.7678f, 33.2323f)
                lineTo(30.2322f, 36.7678f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF57a0ee)),
                    strokeLineWidth = 1.0f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(33.7677f, 36.7678f)
                lineTo(30.2322f, 33.2323f)
            }
        }
        .build()
        return `_snowy-2-day`!!
...
private var `_snowy-2-day`: ImageVector? = null
