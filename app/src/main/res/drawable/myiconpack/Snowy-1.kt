...
public val MyIconPack.`Snowy-1`: ImageVector
    get() {
        if (`_snowy-1` != null) {
            return `_snowy-1`!!
        }
        `_snowy-1` = Builder(name = "Snowy-1", defaultWidth = 56.0.dp, defaultHeight = 48.0.dp,
...
private var `_snowy-1`: ImageVector? = null
