...
public val MyIconPack.`Rainy-3-day`: ImageVector
    get() {
        if (`_rainy-3-day` != null) {
            return `_rainy-3-day`!!
        }
        `_rainy-3-day` = Builder(name = "Rainy-3-day", defaultWidth = 56.0.dp, defaultHeight =
...
private var `_rainy-3-day`: ImageVector? = null
