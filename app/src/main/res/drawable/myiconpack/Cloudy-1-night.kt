...
public val MyIconPack.`Cloudy-1-night`: ImageVector
    get() {
        if (`_cloudy-1-night` != null) {
            return `_cloudy-1-night`!!
        }
        `_cloudy-1-night` = Builder(name = "Cloudy-1-night", defaultWidth = 56.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFFc6deff)), stroke = SolidColor(Color(0xFF000000)),
...
private var `_cloudy-1-night`: ImageVector? = null
